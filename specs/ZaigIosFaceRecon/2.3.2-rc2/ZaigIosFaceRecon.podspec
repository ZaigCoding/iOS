Pod::Spec.new do |s|
    ...
    s.source       = { :http => "https://sdks.sandbox.zaig.com.br/com/zaig/ios/ZaigIosFaceRecon/2.3.2-rc2/ZaigIosFaceRecon.xcframework.zip" }
    ...
    s.dependency 'DatadogInternal', '>= 2.5.0', '<= 2.9.0'
